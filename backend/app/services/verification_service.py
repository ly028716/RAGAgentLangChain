...
class VerificationService:
    ...
    def _check_send_rate_limit(
        self, target: str, code_type: str, ip_address: Optional[str] = None
    ) -> Tuple[bool, str]:
        """
        检查发送频率限制
    ...
    async def send_email_code(
        self, email: str, code_type: str, ip_address: Optional[str] = None
    ) -> dict:
        """
        发送邮箱验证码
        ...
        if not can_send:
            return {"success": False, "message": error_msg, "expires_in": 0}
    ...
    async def send_sms_code(
        self, phone: str, code_type: str, ip_address: Optional[str] = None
    ) -> dict:
        """
        发送短信验证码
    ...
    def verify_code(self, target: str, code: str, code_type: str) -> dict:
        ...
        if verification_code.code != code:
            ...
            return {"success": False, "message": f"验证码错误，还剩{remaining}次机会"}
