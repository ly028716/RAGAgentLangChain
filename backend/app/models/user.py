...
class User(Base):
    ...
    # 账号注销相关字段
    deletion_requested_at = Column(DateTime, nullable=True, comment="注销请求时间")
    deletion_scheduled_at = Column(DateTime, nullable=True, comment="计划删除时间")
    deletion_reason = Column(Text, nullable=True, comment="注销原因")
