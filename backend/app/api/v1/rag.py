...
from app.langchain_integration.rag_chain import get_rag_manager, RAGManager
...
async def rag_query(
    ...
    logger.info(
        ...
        f"kb_ids={payload.knowledge_base_ids}, tokens={response.tokens_used}"
    )
    ...
    async def generate():
        ...
        try:
            ...
            logger.info(
                ...
                f"kb_ids={payload.knowledge_base_ids}, tokens={tokens_used}"
            )
